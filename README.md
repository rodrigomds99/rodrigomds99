...
Atualmente estou no 4º Semestre do curso de Ciência da Computação da Universidade Federal de Santa Catarina (UFSC). Me interesso tanto por front-end e quanto back-end, e as linguagens que mais utilizo no momento são Python e C, mas também possuo conhecimento em C++, C#, Java e Javascript tenho experiências com Liux, Banco de Dados Relacional, Unity e Orientação a Objetos. Estudo e me atualizo na área de tecnologia frequentemente pois adora aprender coisas novas e utilizar meus conhecimentos para encontrar soluções inovadoras!
